...
const fullscreenRoutes = ['/generation-preview', '/classroom/launch'];
  ...
  return (
    <div className="relative min-h-screen bg-white text-slate-900">
      ...
      <div className="pointer-events-none fixed inset-0 overflow-hidden">
        <div className="absolute left-[-10%] top-[-8%] h-[420px] w-[420px] rounded-full bg-slate-200/40 blur-[120px]" />
        <div className="absolute bottom-[-12%] right-[-6%] h-[460px] w-[460px] rounded-full bg-purple-400/10 blur-[140px]" />
